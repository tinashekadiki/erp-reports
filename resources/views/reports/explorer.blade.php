        ...
        <div class="col-md-4 mb-4">
            <div class="card text-center h-100 shadow-sm">
                <div class="card-body d-flex flex-column">
                    ...
                    <!-- Placeholder route or generic config -->
                    <a href="#" class="btn btn-secondary mt-3 rounded-pill px-4 disabled">
                        Coming Soon
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="card text-center h-100 shadow-sm">
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="#" class="btn mt-3 rounded-pill px-4 text-white disabled" style="background-color: #6f42c1;">
                        Coming Soon
                    </a>
                </div>
            </div>
